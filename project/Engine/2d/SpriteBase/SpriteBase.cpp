...
void SpriteBase::CreateRootSignature() {
	...
	// Shaderをコンパイルする
	vertexShaderBlob = DirectXBase::GetInstance()->CompileShader(L"Resources/shaders/Sprite.VS.hlsl", L"vs_6_0");
	assert(vertexShaderBlob != nullptr);
	pixelShaderBlob = DirectXBase::GetInstance()->CompileShader(L"Resources/shaders/Sprite.PS.hlsl", L"ps_6_0");
