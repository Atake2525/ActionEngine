...
public:
    ...
    const int PushKeyInt(BYTE keyNumber);
    ...
    const int TriggerKeyInt(BYTE keyNumber);
    ...
    /// </summary>
    bool PushDPad(DPad dPad);

    /// <summary>
    /// 十字キー(コントローラー)のトリガーをチェック
    /// </summary>
    bool TriggerDPad(DPad dPad);

    /// <summary>
    /// 十字キー(コントローラー)のリターンをチェック
    /// </summary>
    bool ReturnDPad(DPad dPad);
